/* eslint-disable */
// (Sin lint a propósito: es una copia textual de la app, se revisa allá.)
/**
 ...
 */
// COPIA de `src/domain/voiceParser.ts` de la app (el parser offline es/en de
// "Agregar por voz"), para la demo interactiva de la landing. Solo cambian
// los imports: los tipos/constantes que usaba de la app viven en
// `./model`. Si se mejora el parser en la app, copiar los cambios acá.
import { addDays, QUICK_ADD_CATEGORIES, toDateKey, type Language, type PriorityLevel } from './model';

export type VoiceType = 'task' | 'event' | 'note' | 'habit';

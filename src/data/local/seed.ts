...
export async function seedIfEmpty(): Promise<void> {
  ...
  const inboxRows: SeedRow[] = [
    ...
    mk({
      id: 'seed-inbox-invoice-link',
      type: 'task',
      title: 'Cotización del proveedor de catering',
      status: 'inbox',
      date: null,
      priority: 'medium',
      link: 'https://drive.google.com/file/d/quote',
      createdAt: new Date(now.getTime() - 6 * 3600_000).toISOString(),
    }),
    mk({
      id: 'seed-inbox-gym',
      type: 'task',
      title: 'Buscar gimnasio cerca del trabajo nuevo',
      status: 'inbox',
      date: null,
    ...
    mk({
      id: 'seed-inbox-gift',
      type: 'task',
      title: 'Idea de regalo para el cumpleaños de Marcos',
      status: 'inbox',
      date: null,
      priority: 'low',
    ...
    mk({
      id: 'seed-inbox-book',
      type: 'note',
      title: 'Anotar el libro que recomendó Ana',
      status: 'inbox',
      date: null,
      createdAt: new Date(now.getTime() - 2 * 24 * 3600_000).toISOString(),
    }),
    mk({
      id: 'seed-inbox-dentist',
      type: 'task',
      title: 'Llamar al dentista para reprogramar el turno',
      status: 'inbox',
      date: null,
      priority: 'high',

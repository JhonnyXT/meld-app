...
import { WheelDurationPicker } from './WheelDurationPicker';
...
export function DurationPickerModal({ visible, valueMinutes, onCancel, onConfirm }: DurationPickerModalProps) {
    ...
    <Modal visible={visible} transparent animationType="none" onRequestClose={onCancel} statusBarTranslucent>
      <Animated.View style={[styles.backdrop, { opacity }]}>
        ...
        <Animated.View style={[styles.wrap, { transform: [{ scale }] }]}>
          <WheelDurationPicker valueMinutes={valueMinutes} onCancel={onCancel} onConfirm={onConfirm} />
        </Animated.View>
      </Animated.View>
    </Modal>
  );
